...
output = ROOT / "outputs/acceptance-completion/reference-full-song-resumed"
if output.exists():
...
report = {"status": "running", "backend": "original_torch_mps", "listening_status": "pending",
    ...
    "comparison": "Original AR output resumed in a fresh MPS process; same pinned model and seed; not a speed benchmark"}
