...
- Current production environment: Python 3.12, MLX 0.32.2, MLX-LM 0.31.3 and Transformers 5.10.4, without PyTorch (`uv sync --frozen --no-dev`). Development tests use PyTorch 2.13.0. M1–M4 require macOS ≥14.2; the ≥26.2 gate applies specifically to M5. See [the September 15 dependency/platform verification](reports/x-feedback-20260915/REPORT.md). Historical measurements below used older pins and are not current installation guidance.
